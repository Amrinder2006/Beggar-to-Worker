...
app.get("/allcit",function(req,resp){
    resp.sendFile(__dirname+"/public/All-Citizen.html")
})
app.get("/allvol",function(req,resp){
    resp.sendFile(__dirname+"/public/All-Volunteers.html")
})
...
app.get("/Citizendash",function (req,resp) {
    resp.sendFile(__dirname+"/public/Citdash.html")
})

app.get("/Citizencred",function (req,resp) {
    resp.sendFile(__dirname+"/public/Citizen.html")
})
...
let backadhar = req.files?.backadhar;
    ...
    MYSQ.query(
        ...
        [Email, Mob, Name, Adharno, Fathername, dob, gen, Address, city, froadharname, backadharname],
        function (err, result) {
...
app.get("/citdash",function(req,resp){
    resp.sendFile(__dirname+"/public/Citdash.html");
})
